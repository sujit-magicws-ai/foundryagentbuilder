...
#### ❌ INCORRECT: Confusing Agent Framework with AIProjectClient
```python
# WRONG - AIProjectClient.agents is for definition CRUD only, NOT runtime
from azure.ai.projects import AIProjectClient

client = AIProjectClient(endpoint=endpoint, credential=credential)
# client.agents only has: create, create_version, get, list, delete, update
# It does NOT have: create_agent(), threads, messages, runs, streaming
# Use AzureAIAgentsProvider instead for agent runtime operations
```
